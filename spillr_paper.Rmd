...
$$
We proceed as in our standard \texttt{spillR} method to decide whether or not to assign a given count to spillover. This is a computationally efficient and simple baseline that assigns counts to the marker with the highest density at that count value in the corresponding bead experiment.
}
