...
We choose three different experiments to test how robust `spillR` is when one of our three assumptions are violated. We explore a wide range of possible parameter settings. To visualize the different experiments, we summarize the full distributions with the mean of the observed, true, and `spillR` compensated distributions.
