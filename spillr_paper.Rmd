...
# }
levels(combo$correction)[levels(combo$correction) == "none"] <- paste0("none                   ", percentages[1], "% zero counts")
levels(combo$correction)[levels(combo$correction) == "spillR"] <- paste0("spillR                ", percentages[2], "% zero counts")
levels(combo$correction)[levels(combo$correction) == "spillR (naive)"] <- paste0("spillR (naive)    ", percentages[3], "% zero counts")
levels(combo$correction)[levels(combo$correction) == "CATALYST"] <- paste0("CATALYST        ", percentages[4], "% zero counts")
