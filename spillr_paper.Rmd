...
\textcolor{red}{
The goal of the experiment is to estimate the mean of the true counts (black density curve) as accurately as possible from the observed counts (yellow density curve). Using \texttt{NA} imputation for spillover counts, the estimated mean of the compensated observed counts when ignoring \texttt{NA} values is identical to the mean of the true counts if all spillover counts are correctly identified as such.
}
