...
& P^{(1)}(Y_i = 3 \mid Z_i = 1)  =  2/5       & \widehat{P}(\text{spillover} \mid Y_i = 3) = 3/5 \\
& P^{(1)}(Y_i = 5 \mid Z_i = 1)  =  1/5     & \widehat{P}(\text{spillover} \mid Y_i = 5) = 4/5 \\
& P^{(1)}(Y_i = 17 \mid Z_i = 1) =  2/5     & \widehat{P}(\text{spillover} \mid Y_i = 17) = 3/5.
\end{aligned}
$$
