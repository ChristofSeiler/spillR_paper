...
This step is a post-processing step of $\widehat{P}(\text{spillover} \mid Y_i = y)$. Until now, the procedure is fully nonparametric. We apply no regularization to $y$'s that are close to one another. As a result, the spillover probability estimates are noisy and we regularize them using our assumption [(A3)](#assumption3).
...
$$
\begin{aligned}
& P(Z_i = 1 \mid Y_i = 2)  = \frac{1/2 \cdot 1/6}{1/2 \cdot 1/6 + 1/2 \cdot 1/3} = 1/3 \qquad & P(Z_i = 1 \mid Y_i = 2) = 1 - 1/3 = 2/3 \\
& P(Z_i = 1 \mid Y_i = 3)  = \frac{1/2 \cdot 2/6}{1/2 \cdot 2/6 + 1/2 \cdot 2/3} = 1/3 \qquad & P(Z_i = 1 \mid Y_i = 3) = 1 - 1/3 = 2/3 \\
& P(Z_i = 1 \mid Y_i = 5)  = 1 \\
& P(Z_i = 1 \mid Y_i = 17) = 1.
\end{aligned}
$$
* The M step: Update the mixing probability vector,
$$
\pi_1 = \frac{1/3 + 1/3 + 1 + 1}{4} = 2/3 \qquad \pi_2 = \frac{2/3 + 2/3 + 0 + 0}{4} = 1/3,
$$
...
$$
\begin{aligned}
& P^{(0)}(Y_i = 2 \mid Z_i = 1)  =  0 \quad & \widehat{P}(\text{spillover} \mid Y_i = 2) = 1 \\
& P^{(0)}(Y_i = 3 \mid Z_i = 1)  =  0       & \widehat{P}(\text{spillover} \mid Y_i = 3) = 1 \\
& P^{(0)}(Y_i = 5 \mid Z_i = 1)  =  1/3     & \widehat{P}(\text{spillover} \mid Y_i = 5) = 2/3 \\
& P^{(0)}(Y_i = 17 \mid Z_i = 1) =  2/3     & \widehat{P}(\text{spillover} \mid Y_i = 17) = 1/3.
\end{aligned}
$$
