...
\textcolor{red}{
Our assumption (A1) is sometimes true and sometimes violated in the bead and cell data from \texttt{CATALYST}. In particular, in our leading example in Figure \ref{fig:method-example}, we can see that the mode of the bead distribution for marker Yb173Di is very close to the mode in the cell data. So, for this marker our assumption is valid. There are other markers where we see a violation of this assumption.
}
