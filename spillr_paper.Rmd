...
The experiment for [(A1)](#assumption1) shows the performance of our method in settings that are present in the real data. The main challenge is when the distribution in the bead experiment has higher mean than in the real experiment. We observe such patterns in the `CATALYST` example data for protein CD68 with the metal label Eu153Di. In that case, assumption [(A1)](#assumption1) does not hold. For other markers, such as CD45 with metal label Gd160Di, the second mode of the observed marker distribution overlaps with the bead experiment. In that case, assumption [(A1)](#assumption1) holds. 
