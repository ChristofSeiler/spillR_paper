...
* E-step: We calculate the probability of a count $Y_j = y$ actually belonging to marker $j$ from the current estimate of the marker distributions and mixture probability vector:
$$
