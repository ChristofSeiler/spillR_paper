...
\textcolor{red}{
The average computational time with five replications on an Apple M1 with 8 cores and 16 GB of RAM are $10.7$ seconds for \texttt{spillR}, $0.4$ seconds for \texttt{CATALYST}, and $0.5$ seconds for \texttt{spillR} (fast).
}
