...
d_a1 <- expand.grid(
  ...
  rowwise() %>% 
  mutate(diff_mean = compute_average(generate_data_a1, tau))
...
d_a2 <- expand.grid(
  ...
  rowwise() %>% 
  mutate(diff_mean = compute_average(generate_data_a2, tau))
...
d_a3 <- expand.grid(
  ...
  rowwise() %>% 
  mutate(diff_mean = compute_average(generate_data_a3, tau))
