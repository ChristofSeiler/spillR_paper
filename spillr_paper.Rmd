...
Following their set-up, we show the three target proteins on the vertical axis, and plot spillover markers on the horizontal axis.
We show counts of CD3 on the horizontal axis of row one and counts of HLA-ABC on the horizontal axis of row two and three.
}
